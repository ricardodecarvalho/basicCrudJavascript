var botalAdicionar = document.querySelector("#adicionar-paciente");
botalAdicionar.addEventListener("click", function (event) {
...
function montaTr(paciente) {
  var pacienteTr = document.createElement("tr");exibeMensagensDeErro
